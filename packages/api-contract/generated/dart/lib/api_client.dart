...
class ApiClient {
  ApiClient({
    this.basePath = 'http://127.0.0.1:8787',
    this.authentication,
  });
  ...
  static dynamic fromJson(
    ...
    try {
      switch (targetType) {
        ...
        case 'FragmentTranslationResponse':
          return FragmentTranslationResponse.fromJson(value);
        case 'HealthResponse':
          return HealthResponse.fromJson(value);
        case 'TextAssistanceRequest':
          return TextAssistanceRequest.fromJson(value);
        case 'TextExplanationExample':
          return TextExplanationExample.fromJson(value);
        case 'TextExplanationResponse':
          return TextExplanationResponse.fromJson(value);
        case 'WordTranslationRequest':
          return WordTranslationRequest.fromJson(value);
        case 'WordTranslationResponse':
          return WordTranslationResponse.fromJson(value);
        default:
          dynamic match;
          if (value is List &&
